...
int main(int, char**) {
    pcx::globals::username = pcx::get_username();

    WNDCLASSEXW wc{sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"PerceptionCX", nullptr};
    RegisterClassExW(&wc);
    HWND hwnd = CreateWindowW(wc.lpszClassName, L"Perception.cx", WS_OVERLAPPEDWINDOW,
    ...
    pcx::renderer::initialize_fonts();
    gui::initialize("Perception.cx", {500.f, 480.f});
    ...
    while (!done) {
        ...
        pcx::input::begin_frame();

        ImGui_ImplDX11_NewFrame();
        ImGui_ImplWin32_NewFrame();
        ImGui::NewFrame();

        pcx::renderer::begin_frame();
        pcx::input::update();
        gui::tick();
        gui::update();
        widgets::update();
